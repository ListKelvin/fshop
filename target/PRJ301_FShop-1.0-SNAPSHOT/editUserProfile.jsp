        ...
        <main class="col-6  box  " role="main" style="padding: 5rem;">
            ...
            <form id="update-form" method="post" class="row g-4 align-items-center justify-content-center" action="${pageContext.request.contextPath}/MainController?action=UpdateUserInfo" enctype="multipart/form-data">
                ...
                <div class=" col-12 col-lg-6 d-flex align-items-center justify-content-center flex-column ">
                    ...
                    <p class="mt-3 fs-5 fw-semibold">Username: ${requestScope.account.name}</p>
                    ...
                    <div class="row  ">
                        <div class="col-12 col-md-6 p-3">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control  form-control-lg" id="nameTxt" name="nameTxt" value="${user.name}" aria-describedby="nameTxt"  ${param.updateStatus == 0 ? "readonly" : "" }>
                                    <p id="fullnameErr" style="color: white"></p>
                            </div>
                            <div class="form-group">
                                <label for="dobTxt">Date of birth</label>
                                <input required type="date" class="form-control  form-control-lg" name="dobTxt" placeholder="dd/mm/yyyy" id="dobTxt"  value="${user.dob}" aria-describedby="dobTxt"  ${param.updateStatus == 0 ?"readonly" : "" }>
                            </div>
                        ...
                        <div class="col-12 col-md-6 p-3">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control  form-control-lg" id="phone" name="phoneTxt" value="${user.phone}" aria-describedby="phone"  ${param.updateStatus == 0 ? "readonly" : "" }>
...
<!--                                <input type="text" class="form-control  form-control-lg" id="genderTxt" name="genderTxt"  value="${user.gender}" aria-describedby="genderTxt">-->
                                <select required class="form-select form-control-lg" id="genderTxt"   name="genderTxt" aria-label="Default select example"  ${param.updateStatus == 0 ? "disabled ": "" }>
                    ...
                    <div class="form-group ">
                        ...
                        <input required type="text" class="form-control  form-control-lg" id="addressTxt" name="addressTxt" value="${user.address}" aria-describedby="addressTxt" ${param.updateStatus == 0 ? "readonly": "" }>
                    </div> 
